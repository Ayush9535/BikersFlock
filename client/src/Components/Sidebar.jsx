...
import { FaUser, FaEnvelope, FaBell, FaCalendarAlt, FaSignOutAlt, FaPlusSquare, FaHome } from 'react-icons/fa';
      ...
      <div className="flex-1 flex flex-col min-h-0">
        <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
          <nav className="mt-5 flex-1 px-2 space-y-1">
            ...
            <Link to="/chat" className="text-black hover:bg-bforange hover:text-white group flex items-center px-2 py-2 text-base font-medium rounded-md">
